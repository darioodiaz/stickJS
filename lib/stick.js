    ...
    for (var i = 0; i < self.gamepad.buttons.length; i++) {
      if(self.gamepad.buttons[i].pressed) {
        ...
        if (self.buttonFn[ self.buttonMapper["_" + i].toLowerCase() ]) {
          console.log("stickJS: " + self.buttonMapper["_" + i].toLowerCase() + " pressed");
          self.buttonFn[ self.buttonMapper["_" + i].toLowerCase() ](self.gamepad, self.gamepad.buttons[i].value);
        }
      }
    }
